...
class GatherCreditees extends Command
{
    ...
    protected static $defaultDescription = 'Gathers D.O users who have been credited with a commit in the commits.json file generated by the gather:commits command and outputs the results to a json file.';
